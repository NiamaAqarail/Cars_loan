...
public class ReparationServiceImpl implements ReparationService {
    ...
    @Override
    public void addReparation(Integer voitureId, Reparation reparation) {
        Voiture voiture = voitureRepository.findById(voitureId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Invalid car id "+voitureId));
